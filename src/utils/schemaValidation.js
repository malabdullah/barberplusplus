...
export const serviceSchema = {
  required: ['branchId', 'name', 'duration', 'price'],
  types: {
    branchId: 'uuid',
    name: 'string',
    description: 'string',
...
export const customerSchema = {
  required: ['name', 'countryCode', 'phone'],
  types: {
    name: 'string',
    email: 'email',
    phone: 'string',
 ...
 * @returns {{ valid: boolean, errors: string[] }}
 */
export const validateBarber = (data) => validateSchema(data, barberSchema);
 ...
 * @returns {{ valid: boolean, errors: string[] }}
 */
export const validateBranch = (data) => validateSchema(data, branchSchema);
 ...
 * @returns {{ valid: boolean, errors: string[] }}
 */
export const validateService = (data) => validateSchema(data, serviceSchema);
 ...
 * @returns {{ valid: boolean, errors: string[] }}
 */
export const validateCustomer = (data) => validateSchema(data, customerSchema);
